...
public class BoardDao {
	...
	public static SqlSessionFactory ssf = SqlMapClientManager.getSession();
	...
	public void updateBoard(HashMap<String, Object> map) throws SQLException{
		SqlSession session = ssf.openSession(true);
		
		session.update("test.updateBoard", map);
	}
