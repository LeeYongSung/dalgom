...
<script type="text/javascript">
	...
	function call_event(key, no){
		...
		if(key == 2){
			...
			url = "/Exam0331/TestAction!update.lys";
		}
		console.log(data);
		$.ajax({type: "POST",
				url : url,
...
// 		$("#btn").click(function(){
// 			$("table").html("<tr>");
// 			$("table").append("<th>TITLE</th><th>CONTENT</th><th>CNT</th><th>DEL_YN</th><th>REG_USER</th><th>삭제</th>");
// 			$("table").append("</tr>")
// 			$("table").append("<s:iterator value='list'>");
// 			$("table").append("<tr>");
// 			$("table").append("<td><s:property value='TITLE'/></td><td><s:property value='CONTENT'/></td><td><s:property value='CNT'/></td><td><s:property value='DEL_YN'/></td><td><s:property value='REG_USER'/></td><td><button type='button' onclick='call_event(2, '<s:property value='NO'/>')'>삭제</button></td><td><button type='button' onclick='up_event('<s:property value='NO'/>','<s:property value='TITLE'/>','<s:property value='CONTENT'/>')'>수정</button></td>");	
// 			$("table").append("</tr>");
// 			$("table").append("</s:iterator>");
// 		});
// 	});
...
<body>
	...
	<button type="button" onclick="click()" id="btn">생성</button>
