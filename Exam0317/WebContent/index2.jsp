...
<body>
<form id="frS" action="/Exam0317/Servlet" onsubmit="return false;" method="post">
	...
	<table>
		...
		<c:forEach var="list" items="<%= list %>">
			<tr>
				...
				<td>
					<input type="button" value="삭제" class="delete" onclick="del('${ list.No }');">
					<input type="button" value="수정" class="edit" onclick="edit2('${  list.Title }','${ list.No }')">
				</td>
			</tr>	
		</c:forEach>
	</table>
...
<hr>
<form action="/Exam0317/Servlet" method="post">
