...
//        }
	...
	public List<HashMap<String, Object>> selectBoarder(){
		...
		String query = "SELECT * FROM BOARDER WHERE DEL_YN = 'N'";
...
//			conn = DriverManager.getConnection(Url, User, Password);
	...
	public void delBoard(String no){
		String query = "UPDATE BOARDER SET DEL_YN = 'Y' WHERE NO = " + no;
...
//			conn = DriverManager.getConnection(Url, User, Password);
	...
	public void InsertBoard(String title){
		String query = "INSERT INTO BOARDER (NO, TITLE) VALUES (SEQ_BOARDER.NEXTVAL,'" + title + "')";
...
//			conn = DriverManager.getConnection(Url, User, Password);
	...
	public void UpdateBoard(String title, String no){
		String query = "UPDATE BOARDER SET TITLE = '" + title + "' WHERE NO = " + no;
